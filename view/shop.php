		...
		<div id="destaque-produtos">
			...
			<div class="item" ng-repeat="produto in produtos">
				...
				<div class="col-sm-6 col-imagem">
					<a href="produtos-{{produto.id_prod}}" class="btn btn-comprar text-roxo">
				...
				<div class="col-sm-6 col-descricao">
					...
					<a href="produtos-{{produto.id_prod}}" class="btn btn-comprar text-roxo"><i class="fa fa-shopping-cart"></i> Compre agora</a>
				</div>
			...
			<div class="row">
				...
				<div class="col-md-3" ng-repeat="produto in buscados">
					<div class="box-produto-info">
						<a href="produtos-{{produto.id_prod}}">
